...
export function CTASection() {
  return (
    <section className="py-12 bg-gradient-to-r from-primary to-wedding relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container px-4 relative z-10">
        ...
        >
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-primary-foreground">
          ...
          <Button 
            ...
            size="lg" 
            variant="secondary"
            className="px-6 py-5 shadow-elevated hover:scale-105 transition-transform"
          >
            <Link to="/register">
