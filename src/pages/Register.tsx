...
export default function Register() {
  ...
  return (
    <>
      <SEO
        title="Daftar Gratis | Buat Undangan Digital Online"
        description="Daftar gratis di Undanganlink dan mulai buat undangan digital pernikahan, khitanan, ulang tahun dengan template elegan. Proses cepat dan mudah."
        canonical="/register"
      />
